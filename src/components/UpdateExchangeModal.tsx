...
interface UpdateExchangeModalProps {
  exchangeId: string;
  onClose: () => void;
  onUpdate: () => void;
  isUpdating?: boolean;
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <Card className="w-full max-w-md">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
          <div>
            <CardTitle className="text-lg">Update {getExchangeName(exchangeId)} Keys</CardTitle>
            <CardDescription>
              Update your API credentials for {getExchangeName(exchangeId)}
            </CardDescription>
          </div>
          <Button
            variant="ghost"
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center space-x-3 p-3 bg-blue-50 rounded-lg">
            <div className="text-2xl">{getExchangeIcon(exchangeId)}</div>
            <div>
              <h4 className="font-medium">{getExchangeName(exchangeId)}</h4>
            ...
            <div>
              ...
              <div className="relative">
                <Input
                  ...
                  placeholder="Enter your new API secret"
                  value={apiSecret}
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
            <div className="flex items-start">
              ...
              <div className="text-sm text-yellow-800">
                ...
                <p>
                  Updating your API keys will immediately replace the existing ones. 
                  Make sure your new keys are valid and have the required permissions.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex space-x-3 pt-4">
            ...
            <Button
              ...
              disabled={isUpdating || !apiKey.trim() || !apiSecret.trim()}
              className="flex-1"
            >
              {isUpdating ? (
                <>
